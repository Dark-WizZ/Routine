package com.darkwizz.routine.util;
...
import com.darkwizz.routine.data.TaskDao;
...
public abstract class TaskRoomDatabase extends RoomDatabase {
    ...
    public static final RoomDatabase.Callback sRootDatabaseCallback =
            ...
            synchronized (TaskRoomDatabase.class){
                if(INSTANCE == null){
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                            ...
                            .addCallback(sRootDatabaseCallback)
                            .build();
                }
            }
        }
